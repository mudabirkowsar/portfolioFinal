        ...
        <div className='contactMainDiv'>
            <div className="contactDiv">
                ...
                <div className="contactDivText">
                    ...
                    <p className='contactDics'>Feel free to reach out to me for any collaboration, project inquiries, or just a tech chat! I'm always open to discussing new ideas and opportunities.  <br/><br/> You can contact me via email or connect with me on social media.<br/><br/> Let’s create something amazing together!🤤💦💦</p>
